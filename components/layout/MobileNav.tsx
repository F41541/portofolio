          ...
          <div className="grid grid-cols-2 gap-2">
            {SOCIAL_LINKS.map((social) => (
              <a
                ...
                className="flex items-center justify-between min-h-[44px] px-3.5 py-2.5 rounded-xl bg-surface-card/60 border border-border-subtle text-xs text-text-secondary hover:text-text-primary hover:border-accent-emerald/40 transition-all duration-fast ease-spring-natural"
              >
